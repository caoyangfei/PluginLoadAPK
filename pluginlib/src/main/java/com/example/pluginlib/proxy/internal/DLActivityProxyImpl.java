 ...
 */
public class DLActivityProxyImpl {
    ...
    protected DLActivityPlugin mPluginActivity;
    ...
    protected void launchTargetActivity() {
        try {
            ...
            mPluginActivity = (DLActivityPlugin) instance;
            ((DLActivityAttachable) mProxyActivity).attach(mPluginActivity, mPluginManager);

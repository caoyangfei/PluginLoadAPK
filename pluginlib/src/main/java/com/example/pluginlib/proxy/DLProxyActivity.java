...
package com.example.pluginlib.proxy;
...
import com.example.pluginlib.plugin.inter.DLActivityPlugin;
import com.example.pluginlib.proxy.inter.DLActivityAttachable;
import com.example.pluginlib.manager.DLPluginManager;
import com.example.pluginlib.proxy.internal.DLActivityProxyImpl;

/**
 * note: 插件代理宿主activity,预埋manifest
 *
 * @author yangfeicao
 * @see {@link DLActivityProxyImpl}
 */
public class DLProxyActivity extends Activity implements DLActivityAttachable {

    protected DLActivityPlugin mRemoteActivity;
    private DLActivityProxyImpl impl = new DLActivityProxyImpl(this);
    ...
    @Override
    public void attach(DLActivityPlugin remoteActivity, DLPluginManager pluginManager) {

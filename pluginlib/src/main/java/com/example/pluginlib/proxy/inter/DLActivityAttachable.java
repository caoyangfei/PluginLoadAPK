...
package com.example.pluginlib.proxy.inter;
 ...
 * @author mrsimple
 */
public interface DLActivityAttachable {
    /**
     ...
     */
    public void attach(DLActivityPlugin proxyActivity, DLPluginManager pluginManager);
}
